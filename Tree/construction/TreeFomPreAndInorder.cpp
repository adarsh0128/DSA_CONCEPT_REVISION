...
// By using the first element of preorder, we can always find the current root.
// Then, we locate the root in the inorder array to divide the tree into left and right subtrees.
